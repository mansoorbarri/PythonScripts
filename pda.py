...
if __name__ == "__main__":
    url = "https://www.findapprenticeship.service.gov.uk/apprenticeships?sort=AgeAsc&searchTerm=&location=M29+7AR&distance=20&levelIds=4&levelIds=5&levelIds=6&routeIds=7" # Your specific URL
